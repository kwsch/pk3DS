...
public partial class MegaEvoEditor7 : Form
{
    ...
    public MegaEvoEditor7(byte[][] infiles) // All the initial settings
    {
        ...
        groupbox_spec = [GB_MEvo1, GB_MEvo2];
        item_spec = [CB_Item1, CB_Item2];
        forme_spec = [CB_Forme1, CB_Forme2];
        checkbox_spec = [CHK_MEvo1, CHK_MEvo2];
        picturebox_spec = [[PB_S1, PB_S2], [PB_M1, PB_M2]];
        #endregion
        Setup();
