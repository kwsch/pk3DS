...
namespace pk3DS.Core.Structures.PersonalInfo
{
    public class PersonalInfoXY : PersonalInfo
    {
        ...
        public bool Telekenesis { get => (EVYield >> 12 & 1) == 0; set => EVYield = (EVYield & ~(0x1 << 12)) | (value ? 1 : 0) << 12; }
        ...
        public override int FormStatsIndex { get => BitConverter.ToUInt16(Data, 0x1C); protected internal set => BitConverter.GetBytes((ushort)value).CopyTo(Data, 0x1C); }
