...
public sealed partial class TitleScreenEditor6 : Form
{
    ...
    public TitleScreenEditor6()
    {
        ...
        for (int i = 0; i < darcs.Length; i++)
        {
            ...
            darcs[i] = new pk3DS.Core.CTR.DARC(darcData);
        }
    ...
    private readonly pk3DS.Core.CTR.DARC[] darcs = new pk3DS.Core.CTR.DARC[2 * (Main.Config.ORAS ? 8 : 7)];
    ...
    private void InsertFile(string path)
    {
        ...
        pk3DS.Core.CTR.DARC.InsertFile(ref darc, entry, bclim);
    ...
    private void Form_Closing(object sender, FormClosingEventArgs e)
    {
        ...
        for (int i = 0; i < darcs.Length; i++)
        {
            ...
            byte[] darcData = pk3DS.Core.CTR.DARC.SetDARC(darcs[i]);
